...
{
    public static MeshData_ GenerateTreeMesh(List<Line> branches, float angle = 1.05f, float radius = 1f, float thinning = 1f)
    {
        MeshData_ meshData = new MeshData_(branches.Count);
        int vertexIndex = 0;
